...
// viewBox내부에 좌우버튼 만들기---------------------------------------------------------------------------
  ...
  var modalClose = viewBox.find('.close');
// ---------------------------------------------------------
  // 어두운 배경 만들기/숨기기
  var bgBack  = $('.bg_back');
...
*/
  // 모달창에서만 키포커스 움직이기
  modalRight.on('blur',function(event) {
    modalClose.focus();
  });
  // modalRight.on('keydown',function(event) {
  //   if(event.keyCode){ modalClose.focus();  console.log('test'); }
  // });
